...
class One_Button_Add extends One_Button
{
	...
	{
		$output = '<td><a href="#" onclick="document.getElementById( \'task\' ).value = \'add\'; document.getElementById( \'view\' ).value = \'edit\'; document.getElementById( \''.One_Button::getFormId().'\' ).submit(); "><img src="' . One::getInstance()->getUrl() . '/vendor/images/toolset/' . self::getToolset() . '/add.png" title="Add">';
