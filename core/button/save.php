...
class One_Button_Save extends One_Button
{
	...
	{
		$output = '<td><a href="#" onclick="document.getElementById( \'task\' ).value = \'save\'; document.getElementById( \''.One_Button::getFormId().'\' ).submit(); "><img src="' . One::getInstance()->getUrl() . '/vendor/images/toolset/' . self::getToolset() . '/save.png" title="Save">';
