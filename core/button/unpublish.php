...
class One_Button_Unpublish extends One_Button
{
	...
	{
		$output = '<td><a href="#" onclick="document.getElementById( \'task\' ).value = \'unpublish\'; document.getElementById( \''.One_Button::getFormId().'\' ).submit(); "><img src="' . One::getInstance()->getUrl() . '/vendor/images/toolset/' . self::getToolset() . '/unpublish.png" title="unpublish">';
