<?php
/**
 * Handles the checkboxgroup widget
 *
 * @author delius
 * @copyright 2010 delius bvba
 * @package one|content
 * @filesource one/lib/form/widget/multi/checkboxgroup.php
 * @license http://www.gnu.org/licenses/gpl-2.0.html GNU/GPL
 **/
Class One_Form_Widget_Multi_Checkboxgroup extends One_Form_Widget_Abstract
{
	/**
