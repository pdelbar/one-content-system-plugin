<?php
/**
 * Handles a searchfield in the form of checkboxes
 *
 * @author delius
 * @copyright 2010 delius bvba
 * @package one|content
 * @filesource one/lib/form/widget/search/checkbox.php
 * @license http://www.gnu.org/licenses/gpl-2.0.html GNU/GPL
 **/
Class One_Form_Widget_Search_Checkbox extends One_Form_Widget_Search
{
	/**
