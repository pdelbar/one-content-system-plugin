<?php
/**
 * A One_Query object is a meta-representation of a query.
 *
 * @author delius
 * @copyright 2010 delius bvba
 * @package one|content
 * @filesource one/lib/query/query.php
 * @license http://www.gnu.org/licenses/gpl-2.0.html GNU/GPL
 **/
class One_Query implements One_Query_Interface
{
	/**
	 ...
	 */
	public function __construct(One_Scheme_Interface $scheme)
	{
	 ...
	 * @param One_Scheme_Interface $scheme
	 */
	protected function setScheme(One_Scheme_Interface $scheme)
	{
		$this->scheme = $scheme;
	}

	/**
	 * Return the One_Scheme used in this One_Query instance
	 *
	 * @return One_Scheme
	 */
	public function scheme()
	{
		throw new One_Exception_Deprecated('deprecated in favor of getScheme');
		return $this->scheme;
	}
    ...
    {
    	throw new One_Exception_Deprecated('One_Query::count() is no longer used in favor of One_Query::getCount()');
    }
