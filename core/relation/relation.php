 ...
 * @package one|content
 * @filesource one/lib/relation/relation.php
...
class One_Relation
{
	...
	public function createLinks(One_Scheme $scheme)
	{
		...
		// decode relationship, dirty way
		// TR 20080925 adjusted so keys of $this->roles don't necesarilly have to be 0 an 1
	...
	/**
	 * Creates a link for the scheme where this scheme
	 *
	 * @param One_Scheme $scheme
